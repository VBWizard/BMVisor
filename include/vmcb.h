...
struct vmcb_struct {
    ...
    u64 nested_cr3;             /* offset 0xB0 */
    lbrctrl_t lbr_control;      /* offset 0xB8 */
    //was u64 res09;
    u32 clean_bits;             /* offset 0xC0 */
    u32 res09;
    u64 nextrip;                /* offset 0xC8 */
    u64 res10a[102];            /* offset 0xD0 pad to save area */

    struct sDescriptor es;      /* offset 1024 */
    struct sDescriptor cs;
    struct sDescriptor ss;
    struct sDescriptor ds;
    struct sDescriptor fs;
    struct sDescriptor gs;
    struct sDescriptor gdtr;
    struct sDescriptor ldtr;
    struct sDescriptor idtr;
    struct sDescriptor tr;
    u64 res10[5];
    u8 res11[3];
    u8 cpl;
    u32 res12;
...
enum INTERCEPTS
{
    ...
    INTERCEPT_IOIO = 1 << 27,
    INTERCEPT_EXCEPTION_14 = 1 << 14,
    INTERCEPT_EXCEPTION_16 = 1 << 16
};
