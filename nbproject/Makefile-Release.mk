...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/bmvisor: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/bmvisor ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/src/0-visor_main.o: src/0-visor_main.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/0-visor_main.o src/0-visor_main.c

${OBJECTDIR}/src/guest.o: src/guest.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/guest.o src/guest.c

${OBJECTDIR}/src/host.o: src/host.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/host.o src/host.c

${OBJECTDIR}/src/isr_wrapper.o: src/isr_wrapper.asm 
	${MKDIR} -p ${OBJECTDIR}/src
	$(AS) $(ASFLAGS) -o ${OBJECTDIR}/src/isr_wrapper.o src/isr_wrapper.asm

${OBJECTDIR}/src/memmap.o: src/memmap.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memmap.o src/memmap.c

${OBJECTDIR}/src/pmode.o: src/pmode.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pmode.o src/pmode.c

${OBJECTDIR}/src/pmode_screen.o: src/pmode_screen.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pmode_screen.o src/pmode_screen.c
...
${OBJECTDIR}/src/x86.o: src/x86.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/x86.o src/x86.c
